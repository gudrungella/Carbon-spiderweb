...
def build_data(summary, op_rows, emb_rows, cell_sites, sensitivity=None, uncertainty=None, enriched=None):
    ...
    enriched = enriched if enriched is not None else _load_enriched_rows()
    data_quality = {
